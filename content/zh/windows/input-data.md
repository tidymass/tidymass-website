...
commentable: false
editable: false
translationKey: "windows-input-data"
---
...
{{< tutorial-figure src="/tutorial-images/windows-input-data-zh.svg" caption="原始文件与样本表对应。步骤编号表示阅读顺序；此图为流程示意。" >}}
...
开始前用 [Sample & file checker](/zh/windows/analysis-tools/) 排查重复、缺失和未预期的文件，尤其适合多批次项目。
