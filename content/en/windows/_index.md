...
**Windows x64 0.1.63** — Preview; updated September 23, 2026. Platform versions are documented separately: newer features on another platform do not imply availability here.
...
4. [Tasks, reruns and version differences](tasks-and-reruns/)
...
{{< tutorial-figure src="/tutorial-images/windows-_index-en.svg" caption="Desktop analysis at a glance. Numbers show the reading order; this is a schematic." >}}
