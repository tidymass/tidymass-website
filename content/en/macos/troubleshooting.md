...
commentable: false
editable: false
translationKey: "macos-troubleshooting"
---
...
| A trial completed but processing remains unfinished | Run **Process raw data** for the formal dataset |
...
When memory is high, compare **Computer used** with **TidyMass used**, reduce worker count or trial size, and inspect other system processes. More threads do not always make analysis faster.
...
{{< tutorial-figure src="/tutorial-images/macos-troubleshooting-en.svg" caption="Find the first failing step. Numbers show the reading order; this is a schematic." >}}
