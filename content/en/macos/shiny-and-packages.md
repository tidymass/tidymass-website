...
{{< tutorial-figure src="/tutorial-images/macos-shiny-and-packages-en.svg" caption="Manage optional R applications. Numbers show the reading order; this is a schematic." >}}
...
{{< tutorial-figure src="/tutorial-images/desktop/shiny-tools.png" caption="Launch an installed Shiny tool. Actual macOS preview 0.1.39 screenshot with the MAPA example." >}}
