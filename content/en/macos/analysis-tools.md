...
{{< tutorial-figure src="/tutorial-images/macos-analysis-tools-en.svg" caption="Choose the smallest relevant tool. Numbers show the reading order; this is a schematic." >}}
...
{{< tutorial-figure src="/tutorial-images/desktop/analysis-tools.png" caption="Choose an independent tool. Actual macOS preview 0.1.56 screenshot; card layout may vary in later builds." >}}
