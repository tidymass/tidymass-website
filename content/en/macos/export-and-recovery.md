...
{{< tutorial-figure src="/tutorial-images/macos-export-and-recovery-en.svg" caption="Export the run you actually reviewed. Numbers show the reading order; this is a schematic." >}}
...
{{< tutorial-figure src="/tutorial-images/desktop/export.png" caption="Choose export scope and contents. Actual macOS preview 0.1.43 example screenshot; controls shown remain useful for understanding export." >}}
